...
printf "${authorized_worker_keys}" > /etc/concourse/keys/web/authorized_workers
printf "${session_signing_key}" > /etc/concourse/keys/web/session_signing_key
printf "${tsa_host_key}" > /etc/concourse/keys/web/tsa_host_key
